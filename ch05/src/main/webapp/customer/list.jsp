...
try {
	...
	// jdbc/hyokong 커넥셕풀 검색
	DataSource ds = (DataSource) ctx.lookup("jdbc/hyokong"); // jdbc/hyokong 커넥션풀 객체 검색
...
<body>
	...
	<table border="1">
		...
		<tr>
			...
			<td><a href="/ch05/customer/modify.jsp?cid<=% customer.getCid()">수정</a>
